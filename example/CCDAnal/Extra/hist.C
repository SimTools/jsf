...
//    hPh3=new TH1F("hPh3","CCD3 pulse height ",100, 2000.0, 2100.0);
    ...
    hPh0=new TH1F("hPh0","CCD0 pulse height ",220, -20, 200);
    hPh1=new TH1F("hPh1","CCD1 pulse height ",220, -20, 200);
    hPh2=new TH1F("hPh2","CCD2 pulse height ",220, -20, 200);
    hPh3=new TH1F("hPh3","CCD3 pulse height ",220, -20, 200);
...
int hist()
{
  ...
  printf(" jsf->BerginRun is called.\n");
