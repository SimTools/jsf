...
void JSFEventDisplay::DisplayEventData()
{
  ...
  switch (fDisplayType) {
    case 0:
      ...
      break;
    case 1:
      if( strncmp(((JSFSIMDSTBuf*)(simdst->EventBuf()))->GetProducer(),"JIM",3) == 0 ) {
	if( fEMCHit->fShow )     DisplayJIMEMCHits();
	if( fHDCHit->fShow )     DisplayJIMHDCHits();
      }
      else {
...
//---------------------------------------------------------------------------
void JSFEventDisplay::DisplayJIMEMCHits()
{
...
//---------------------------------------------------------------------------
void JSFEventDisplay::DisplayJIMHDCHits()
{
  JSFSIMDSTBuf *sdb=(JSFSIMDSTBuf*)simdst->EventBuf();
